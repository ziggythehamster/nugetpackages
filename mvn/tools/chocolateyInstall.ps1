...
$url = "http://www.us.apache.org/dist/maven/maven-3/$version/binaries/$name-bin.zip"
...
Install-ChocolateyZipPackage 'mvn' $url $binRoot #download the maven .zip and unzip in $binRoot folder
